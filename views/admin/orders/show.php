                    ...
                    <div class="card">
                        <div class="col-sm-12">
                            <form action="index.php?controller=orders&action=search" method="POST">
                                ...
                                <a href="index.php?controller=orders" class="btn btn-primary">Hủy</a>
                            </form>
                        </div>
                                            ...
                                            <?php foreach ($arr_orders as $key => $data) { ?>
                                                ...
                                                <td class="text-center py-0 align-middle">
                                                    <div class="btn-group btn-group-sm">
                                                        <a href="index.php?controller=orderitems&action=order&id=<?php echo $data['id'] ?>" class="btn btn-info"><i class="fas fa-info"></i></a>
                                                    </div>
                                                </td>
